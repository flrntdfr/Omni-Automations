...
### <code>function <a name='ColorConstructor.hex'>hex</a>(hexString: `String`, a: `Number` or `null`)</code> → [`Color`](#Color) or `null`
...
### <code>var <a name='OAColor.hex'>hex</code></a> → `String` *read-only*
...
### <code>var <a name='Device.get_operatingSystemBuildNumber'>operatingSystemBuildNumber</code></a> → `String` *read-only*
...
### <code>function <a name='NSDocument.createOmniLinkURL'>createOmniLinkURL</a>(additionalQueryItems: `Array` of [`URL.QueryItem`](#URL.QueryItem) or `null`, additionalPromptMessage: `String` or `null`)</code> → [`Promise`](#Promise) of [`URL`](#URL)
...
### <code>var <a name='NSDocument.fileURL'>fileURL</code></a> → [`URL`](#URL) or `null` *read-only*
...
### <code>var <a name='NSDocument.omniLink'>omniLink</code></a> → [`URL`](#URL) or `null` *read-only*
...
# <a name='LanguageModel'><code>LanguageModel</code></a>



# <a name='LanguageModel.GenerationOptions'><code>LanguageModel.GenerationOptions</code></a>



## Constructors

### <code>new <a name='OJSLanguageModelGenerationOptionsConstructor.constructInstance'>LanguageModel.GenerationOptions</a>()</code> → [`LanguageModel.GenerationOptions`](#LanguageModel.GenerationOptions)


## Instance Properties

### <code>var <a name='OJSLanguageModelGenerationOptions.maximumResponseTokens'>maximumResponseTokens</code></a> → `Number` or `null`
 See Apple's documentation for `maximumResponseTokens`.
<br/><br/>


# <a name='LanguageModel.Schema'><code>LanguageModel.Schema</code></a>
...
### <code>function <a name='OJSAbstractSchemaConstructor.fromJSON'>fromJSON</a>(json: [`Object`](#Object))</code> → [`LanguageModel.Schema`](#LanguageModel.Schema)
 Returns a `LanguageModel.Schema` based on the provided JSON schema. Schemas can be named and recursively referenced.
<br/><br/>


# <a name='LanguageModel.Session'><code>LanguageModel.Session</code></a>



## Constructors

### <code>new <a name='LanguageModelConstructor.constructInstance'>LanguageModel.Session</a>(instructions: `String` or `null`)</code> → [`LanguageModel.Session`](#LanguageModel.Session)
...
### <code>function <a name='AbstractLanguageModel.respond'>respond</a>(prompt: `String`)</code> → [`Promise`](#Promise) of `String`
 Produces a text response to a prompt.
<br/><br/>


### <code>function <a name='AbstractLanguageModel.respondWithSchema'>respondWithSchema</a>(prompt: `String`, schema: [`LanguageModel.Schema`](#LanguageModel.Schema), generationOptions: [`LanguageModel.GenerationOptions`](#LanguageModel.GenerationOptions) or `null`)</code> → [`Promise`](#Promise) of `String`
...
### <code>var <a name='OFMPerspective.iconColor'>iconColor</code></a> → [`Color`](#Color) or `null`
...
### <code>var <a name='OFMProjectInfo.get_effectivePlannedDate'>effectivePlannedDate</code></a> → `Date` or `null` *read-only*
...
### <code>var <a name='OFMProjectInfo.get_plannedDate'>plannedDate</code></a> → `Date` or `null`
...
### <code>var <a name='OFMContext.get_childrenAreMutuallyExclusive'>childrenAreMutuallyExclusive</code></a> → `Boolean`
...
### <code>var <a name='OFMTask.get_effectivePlannedDate'>effectivePlannedDate</code></a> → `Date` or `null` *read-only*
...
### <code>var <a name='OFMTask.get_plannedDate'>plannedDate</code></a> → `Date` or `null`
...
# <a name='Task.AnchorDateKey'><code>Task.AnchorDateKey</code></a>



## Class Properties

### <code>var <a name='_Task_AnchorDateKey_GeneratedWrapperConstructor.DeferDate'>DeferDate</code></a> → [`Task.AnchorDateKey`](#Task.AnchorDateKey) *read-only*


### <code>var <a name='_Task_AnchorDateKey_GeneratedWrapperConstructor.DueDate'>DueDate</code></a> → [`Task.AnchorDateKey`](#Task.AnchorDateKey) *read-only*


### <code>var <a name='_Task_AnchorDateKey_GeneratedWrapperConstructor.PlannedDate'>PlannedDate</code></a> → [`Task.AnchorDateKey`](#Task.AnchorDateKey) *read-only*


### <code>var <a name='_Task_AnchorDateKey_GeneratedWrapperConstructor.all'>all</code></a> → `Array` of [`Task.AnchorDateKey`](#Task.AnchorDateKey) *read-only*
...
### <code>new <a name='RepetitionRuleConstructor.constructInstance'>Task.RepetitionRule</a>(ruleString: `String` or `null`, method: [`Task.RepetitionMethod`](#Task.RepetitionMethod) or `null`, scheduleType: [`Task.RepetitionScheduleType`](#Task.RepetitionScheduleType) or `null`, anchorDateKey: [`Task.AnchorDateKey`](#Task.AnchorDateKey) or `null`, catchUpAutomatically: `Boolean` or `null`)</code> → [`Task.RepetitionRule`](#Task.RepetitionRule)
...
### <code>function <a name='OFMRepetitionRule.firstDateAfterDate'>firstDateAfterDate</a>(date: `Date`)</code> → `Date` or `null`
...
### <code>var <a name='OFMRepetitionRule.anchorDateKey'>anchorDateKey</code></a> → [`Task.AnchorDateKey`](#Task.AnchorDateKey) *read-only*
 The date property to use when updating a repeating item for its next occurrence.
<br/><br/>


### <code>var <a name='OFMRepetitionRule.catchUpAutomatically'>catchUpAutomatically</code></a> → `Boolean` *read-only*
...
### <code>var <a name='OFMRepetitionRule.scheduleType'>scheduleType</code></a> → [`Task.RepetitionScheduleType`](#Task.RepetitionScheduleType) *read-only*
...
# <a name='Task.RepetitionScheduleType'><code>Task.RepetitionScheduleType</code></a>



## Class Properties

### <code>var <a name='_Task_RepetitionScheduleType_GeneratedWrapperConstructor.FromCompletion'>FromCompletion</code></a> → [`Task.RepetitionScheduleType`](#Task.RepetitionScheduleType) *read-only*


### <code>var <a name='_Task_RepetitionScheduleType_GeneratedWrapperConstructor.None'>None</code></a> → [`Task.RepetitionScheduleType`](#Task.RepetitionScheduleType) *read-only*
 The task does not repeat.
<br/><br/>


### <code>var <a name='_Task_RepetitionScheduleType_GeneratedWrapperConstructor.Regularly'>Regularly</code></a> → [`Task.RepetitionScheduleType`](#Task.RepetitionScheduleType) *read-only*


### <code>var <a name='_Task_RepetitionScheduleType_GeneratedWrapperConstructor.all'>all</code></a> → `Array` of [`Task.RepetitionScheduleType`](#Task.RepetitionScheduleType) *read-only*
...
### <code>var <a name='TypeIdentifierConstructor.utf8PlainText'>utf8PlainText</code></a> → [`TypeIdentifier`](#TypeIdentifier) *read-only*
...
### <code>function <a name='URLConstructor.omniLink'>omniLink</a>(path: `String`, folderName: `String`)</code> → [`URL`](#URL)
 Constructs an Omni Link for a given path inside a Connected Folder.
<br/><br/>


### <code>function <a name='URLConstructor.resolveFileURLForOmniLink'>resolveFileURLForOmniLink</a>(omniLink: [`URL`](#URL), additionalPromptMessage: `String` or `null`, additionalQueryItems: `Array` of [`URL.QueryItem`](#URL.QueryItem) or `null`)</code> → [`Promise`](#Promise) of [`URL`](#URL)
 Resolves an Omni Link into a file URL.
<br/><br/>


### <code>function <a name='URLConstructor.omniLinkForFileURL'>omniLinkForFileURL</a>(fileURL: [`URL`](#URL), additionalQueryItems: `Array` of [`URL.QueryItem`](#URL.QueryItem) or `null`, additionalPromptMessage: `String` or `null`)</code> → [`Promise`](#Promise) of [`URL`](#URL)
